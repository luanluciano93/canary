local spells = {
	-- Instant spell
	{
		...
		npc = { "barnabas dee", "chatterbone", "etzel", "lea", "malunga", "muriel", "myra", "romir", "tamoril", "tothdral", "marvik", "padreia", "rahkem", "smiley", "tamara", "ustan", "hjaern", "charlotta", "azalea", "dario", "elane", "ethan", "hawkyr", "helor", "isolde", "legola", "silas", "ursula", "duria", "gregor", "ormuhn", "puffels", "thorwulf", "trisha", "tristan", "uso", "shalmar", "gundralph",
			"faluae", "asrak", "razan" },
		price = 80,
	...
	},
	{
		name = "light",
		group = "support spells",
		npc = { "barnabas dee", "chatterbone", "etzel", "lea", "malunga", "muriel", "myra", "romir", "tamoril", "tothdral", "marvik", "padreia", "rahkem", "smiley", "tamara", "ustan", "hjaern", "charlotta", "azalea", "dario", "elane", "ethan", "hawkyr", "helor", "isolde", "legola", "silas", "ursula", "duria", "gregor", "ormuhn", "puffels", "thorwulf", "trisha", "tristan", "uso", "shalmar", "maealil",
			"gundralph", "faluae", "asrak", "razan" },
		price = 0,
